...
// Adapted from
// https://github.com/JunshengFu/Model-Predictive-Control/tree/master/src/MPC.h and MPC.cpp

static size_t N = 10;
static double dt = 0.12;  //tested with 0.3, 0.12, 0.1, 0.08
...
static size_t delta_start = psi_start + N;
...
public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    for (i = 0; i < N - 1; i++) {
      ...
      fg[2 + psi_start + i]  = psi1 - (psi0 + delta0 * dt);
