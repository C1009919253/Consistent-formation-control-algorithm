...
public:
    MinimalPublisher(): Node("minimal_publisher"), count_(0)
    {
        ...
        timer1 = this->create_wall_timer(50ms, std::bind(&MinimalPublisher::timer1_callback, this));
        timer2 = this->create_wall_timer(50ms, std::bind(&MinimalPublisher::timer2_callback, this));

        subscription1 = this->create_subscription<nav_msgs::msg::Odometry>("demo1/odom_demo", 10, std::bind(&MinimalPublisher::topic1_callback, this, _1));
        subscription2 = this->create_subscription<nav_msgs::msg::Odometry>("demo2/odom_demo", 10, std::bind(&MinimalPublisher::topic2_callback, this, _1));
        subscription3 = this->create_subscription<nav_msgs::msg::Odometry>("demo3/odom_demo", 10, std::bind(&MinimalPublisher::topic3_callback, this, _1));
